...
import { conflictFiles, type ConflictFile, type ConflictRegion } from "../pages/jpe-data";
    ...
    <div className="flex flex-col h-full" style={{ background: T.bgDeep }}>
      ...
      <div className="flex items-center justify-between px-4 py-1.5 flex-shrink-0" style={{ borderBottom: `1px solid ${T.border}`, background: T.bgPanel }}>
        <div className="flex items-center gap-3">
          ...
          <Badge color={severityColor} bg={`${severityColor}10`}>{file.severity.toUpperCase()}</Badge>
        ...
        {conflictFiles.map(cf => {
          ...
          return (
            ...
            >
              ...
              <span style={{ fontSize: 11, fontFamily: T.mono, fontWeight: isAct ? 600 : 400 }}>{cf.filename.split("_").slice(1).join("_")}</span>
