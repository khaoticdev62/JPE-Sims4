...
import { X, ChevronRight, ChevronLeft, Sparkles, Check, Code2, Languages, Library, Rocket, Bug, Lightbulb } from "lucide-react";
...
export function OnboardingTour({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    if (isLastStep) {
      ...
      setTimeout(() => {
        ...
        toast.success("Tutorial completed!", {
          description: "Press Ctrl+/ to view keyboard shortcuts anytime.",
        });
  ...
  const handleSkip = () => {
    ...
    toast.info("Tutorial skipped", {
      description: "You can restart it from Settings > General",
    });
  };
        ...
        >
            ...
            {tourSteps.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 4,
                  background: i === currentStep ? step.iconColor : i < currentStep ? `${step.iconColor}40` : T.border,
          ...
          <div className="flex gap-3 justify-between">
            ...
            <JpeButton
              ...
              className="flex-1"
            >
              {isLastStep ? (completed ? "Completed!" : "Finish") : "Next"}
            </JpeButton>
          </div>
