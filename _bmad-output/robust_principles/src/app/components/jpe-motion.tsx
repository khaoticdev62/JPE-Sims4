...
function useTransition(t: Transition): Transition {
...
export function AnimatedPanel({
  ...
  return (
    <motion.div
      ...
      className={className}
      style={{ ...style, width, willChange: "transform, opacity" }}
    >
      {children}
    </motion.div>
  );
...
export function PopoverMotion({
  ...
  return (
    <motion.div
      ...
      className={className}
      style={{ ...style, willChange: "transform, opacity", transformOrigin: "top left" }}
    >
      {children}
    </motion.div>
  );
    ...
    <AnimatePresence initial={false}>
      {isOpen && (
        <motion.div
          ...
          className={className}
          style={{ ...style, overflow: "hidden", willChange: "height, opacity" }}
        >
          {children}
        </motion.div>
      )}
