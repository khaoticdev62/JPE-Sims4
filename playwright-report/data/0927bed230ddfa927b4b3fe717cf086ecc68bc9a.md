...
- Name: dialog.e2e.ts >> Dialog Component >> should render dialog title
- Location: src\__tests__\e2e\specs\dialog.e2e.ts:26:7
...
Locator: getByTestId('dialog-title')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('dialog-title')
