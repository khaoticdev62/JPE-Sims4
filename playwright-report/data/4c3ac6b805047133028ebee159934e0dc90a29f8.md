...
- Name: dialog.e2e.ts >> Dialog Component >> should close dialog on backdrop click
- Location: src\__tests__\e2e\specs\dialog.e2e.ts:79:7
...
Call log:
  - waiting for locator('[class*="DialogOverlay"]').first()
