/**
 * OpenAI API - Explain Mod File
 * Server-side endpoint for GPT-4o mod explanations.
...
\nReturn the summary in the specified structured text format.`;
    ...
    // Note: Explanation parsing is handled on the client side for consistency.
    ...
    console.error('[OpenAI API Explain] Error:', error);
