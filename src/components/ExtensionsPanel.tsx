...
import {
  ...
  Shield, Sparkles, ToggleLeft, ToggleRight,
  RefreshCw, Tag, Package,
  Code2, Zap, BookOpen, Eye, Languages,
} from "lucide-react";
...
const _CATEGORIES = ["All", "AI & Intelligence", "Validation", "Localization", "Package Tools", "Version Control", "Testing", "Documentation", "Themes"];

/* ─── Main component ─── */
export function ExtensionsPanel() {
  const [search, setSearch] = useState("");
  const [selectedCat, _setSelectedCat] = useState("All");
