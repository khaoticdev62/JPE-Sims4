...
import {
  ...
  ArrowLeftRight, AlignLeft, Copy, Check,
  Hash, ChevronsUpDown, GitMerge} from "lucide-react";
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          style={{ background: "rgba(7,8,16,0.94)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)" }}
        >
          {/* Top accent gradient */}
