...
import {
  ...
  Copy, Download, Play, StepForward, Database,
  Clock, Activity, Eye,
  Globe, FileCode,
  RefreshCw, Terminal, Brain, Layers,
  Star, Info, MessageSquare, ChevronRight,
  Plus, ExternalLink} from "lucide-react";
import { T } from "./robust/jpe-theme";
import type { WorkspaceMode } from "./robust/jpe-theme";
import { GlowDot, Badge, PanelHeader} from "./robust/jpe-shared";
...
/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
function TranslationInspector({ onNavigate: _onNavigate }: { onNavigate: (m: WorkspaceMode) => void }) {
  return (
    <div className="flex flex-col h-full" style={{ background: T.bgPanel, fontFamily: T.sans }}>
...
/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
function ConflictsInspector({ onNavigate: _onNavigate }: { onNavigate: (m: WorkspaceMode) => void }) {
  const total = 5;
  const resolved = 2;
...
/* ══════════════════════════════════════════════════════════════
   11. DEBUG INSPECTOR
   ══════════════════════════════════════════════════════════════ */
function DebugInspector({ onNavigate: _onNavigate }: { onNavigate: (m: WorkspaceMode) => void }) {
  const [watches, _setWatches] = useState([
...
/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
function AnalysisInspector({ onNavigate: _onNavigate }: { onNavigate: (m: WorkspaceMode) => void }) {
...
/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
function SettingsInspector({ onNavigate: _onNavigate }: { onNavigate: (m: WorkspaceMode) => void }) {
  const sections = [
