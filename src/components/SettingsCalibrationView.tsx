...
import {
  ...
  History, Layers,
  Server, Wifi, MemoryStick, ThermometerSun} from "lucide-react";
...
export function SettingsCalibrationView() {
  ...
  const { usageStats: _usageStats, activeProvider: _activeProvider, setApiKey: _setApiKey } = useAIStore();
  const { stats: _stats } = useTelemetryStore();
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-8 py-3.5 flex-shrink-0" style={{ borderBottom: `1px solid ${T.border}`, background: T.bgPanel }}>
          <div className="flex items-center gap-4">
            ...
            >
              {currentProject?.name || "Workspace-01"}
            </span>
          </div>
          <div className="flex items-center gap-2.5">
            <button
            ...
            <div className="max-w-5xl relative">
              ...
              >
                <PathField
                  ...
                  value={currentProject?.rootPath || "/volumes/nas/projects/workspace_01/data"}
