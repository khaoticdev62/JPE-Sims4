...
export const jpeSourceLines: JpeEditorLine[] = ([
  { num: 1, text: "# \u2550\u2550\u2550 Friendly Hug Interaction \u2550\u2550\u2550", tokens: [], hint: "Section header", validationStatus: "valid" as const },
  { num: 2, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 3, text: "interaction: hug_friend", tokens: [], hint: "Defines a new social interaction", validationStatus: "valid" as const },
  { num: 4, text: '  display_name "Friendly Hug"', tokens: [], validationStatus: "valid" as const },
  { num: 5, text: '  description "Give a warm, friendly hug"', tokens: [], validationStatus: "valid" as const },
  { num: 6, text: "  icon friendly_hug_icon", tokens: [], validationStatus: "valid" as const },
  { num: 7, text: "  category FRIENDLY", tokens: [], validationStatus: "valid" as const },
  { num: 8, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 9, text: "  # Requirements", tokens: [], validationStatus: "valid" as const },
  { num: 10, text: "  requires friendship > 40", tokens: [], hint: "Minimum relationship score", validationStatus: "valid" as const },
  { num: 11, text: "  requires age TEEN or YOUNGADULT or ADULT or ELDER", tokens: [], validationStatus: "valid" as const },
  { num: 12, text: "  not requires trait evil", tokens: [], validationStatus: "valid" as const },
  { num: 13, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 14, text: "  # Effects", tokens: [], validationStatus: "valid" as const },
  { num: 15, text: "  gives moodlet happy_small", tokens: [], hint: "Applies a buff to the Sim", validationStatus: "valid" as const },
  { num: 16, text: "    duration 2 hours", tokens: [], validationStatus: "valid" as const },
  { num: 17, text: "  gives friendship + 5 points", tokens: [], validationStatus: "valid" as const },
  { num: 18, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 19, text: "  # Autonomy", tokens: [], validationStatus: "valid" as const },
  { num: 20, text: "  autonomy chance 35 percent", tokens: [], validationStatus: "valid" as const },
  { num: 21, text: "  targets SIM with friendship > 30", tokens: [], validationStatus: "valid" as const },
  { num: 22, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 23, text: "  # Outcomes", tokens: [], validationStatus: "valid" as const },
  { num: 24, text: "  outcome SUCCESS chance 85 percent", tokens: [], warning: "Consider adding a failure animation reference", validationStatus: "warning" as const, quickFix: { label: "Add animation ref", replacement: '  outcome SUCCESS chance 85 percent\n    animation "hug_success"' } },
  { num: 25, text: '    loot "friendship_boost_small"', tokens: [], validationStatus: "valid" as const },
  { num: 26, text: "  outcome FAILURE chance 15 percent", tokens: [], validationStatus: "valid" as const },
  { num: 27, text: "    gives moodlet embarrassed_small", tokens: [], validationStatus: "valid" as const },
  { num: 28, text: "    duration 1 hour", tokens: [], validationStatus: "valid" as const },
  { num: 29, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 30, text: "# \u2550\u2550\u2550 Trait: Hugger \u2550\u2550\u2550", tokens: [], validationStatus: "valid" as const },
  { num: 31, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 32, text: "trait: hugger_trait", tokens: [], hint: "Defines a new personality trait", validationStatus: "valid" as const },
  { num: 33, text: '  display_name "Hugger"', tokens: [], validationStatus: "valid" as const },
  { num: 34, text: '  description "This Sim loves giving hugs to everyone"', tokens: [], validationStatus: "valid" as const },
  { num: 35, text: "  category PERSONALITY", tokens: [], validationStatus: "valid" as const },
  { num: 36, text: "  age TEEN YOUNGADULT ADULT ELDER", tokens: [], validationStatus: "valid" as const },
  { num: 37, text: "  conflicts_with trait distant", tokens: [], validationStatus: "valid" as const },
  { num: 38, text: "  conflicts_with trait mean_spirited", tokens: [], validationStatus: "valid" as const },
  { num: 39, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 40, text: "  # Trait bonuses", tokens: [], validationStatus: "valid" as const },
  { num: 41, text: "  gives skill charisma + 1", tokens: [], validationStatus: "valid" as const },
  { num: 42, text: "  gives hug_friend autonomy + 20 percent", tokens: [], validationStatus: "valid" as const },
  { num: 43, text: "", tokens: [], validationStatus: "valid" as const },
  { num: 44, text: "  # Passive buff", tokens: [], validationStatus: "valid" as const },
  { num: 45, text: "  buff: warm_aura", tokens: [], validationStatus: "valid" as const },
  { num: 46, text: '    display_name "Warm Presence"', tokens: [], validationStatus: "valid" as const },
  { num: 47, text: '    description "Feeling the love radiating outward"', tokens: [], validationStatus: "valid" as const },
  { num: 48, text: "    gives SOCIAL + 2", tokens: [], error: 'Unknown motive key "SOCIAL". Did you mean social_need?', validationStatus: "error" as const, quickFix: { label: "Replace with social_need", replacement: "    gives social_need + 2" } },
] as const).map(l => ({ ...l, tokens: tokenizeJpeLine(l.text) }));
...
export const jpeSuggestions = [
  { trigger: "inter", completion: "interaction:", desc: "Define a new interaction", icon: Zap, color: T.violet, detail: "Top-level declaration block" },
  { trigger: "trait", completion: "trait:", desc: "Define a new trait", icon: Star, color: T.cyan, detail: "Personality trait declaration" },
  { trigger: "buff", completion: "buff:", desc: "Define a new buff/moodlet", icon: Heart, color: T.rose, detail: "Temporary emotional state" },
  { trigger: "req", completion: "requires", desc: "Add a requirement test", icon: Shield, color: T.amber, detail: "Prerequisite condition" },
  { trigger: "give", completion: "gives", desc: "Apply an effect/loot", icon: Sparkles, color: T.emerald, detail: "Outcome effect action" },
  { trigger: "dur", completion: "duration", desc: "Set time duration", icon: Clock, color: T.cyanBright, detail: "Time span modifier" },
  { trigger: "chan", completion: "chance", desc: "Set probability", icon: Activity, color: T.rose, detail: "Percentage weight" },
  { trigger: "tar", completion: "targets", desc: "Define target filter", icon: Eye, color: T.cyan, detail: "Target Sim/Object test" },
  { trigger: "aut", completion: "autonomy", desc: "Configure AI behavior", icon: Cpu, color: T.emerald, detail: "NPC decision weight" },
  { trigger: "out", completion: "outcome", desc: "Define outcome branch", icon: GitBranch, color: T.amber, detail: "Success/Failure path" },
  { trigger: "dis", completion: 'display_name ""', desc: "Set display name", icon: FileText, color: T.textMuted, detail: "UI label string" },
  { trigger: "des", completion: 'description ""', desc: "Set description", icon: FileText, color: T.textMuted, detail: "Tooltip text" },
  { trigger: "cat", completion: "category", desc: "Set category type", icon: Layers, color: T.violet, detail: "Classification enum" },
  { trigger: "con", completion: "conflicts_with", desc: "Define trait conflict", icon: AlertTriangle, color: T.rose, detail: "Mutual exclusion" },
];
