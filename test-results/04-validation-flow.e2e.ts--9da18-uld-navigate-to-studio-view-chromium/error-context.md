...
- Name: 04-validation-flow.e2e.ts >> E2E: Real-Time Validation Flow >> should navigate to studio view
- Location: src\__tests__\e2e\specs\04-validation-flow.e2e.ts:32:7
