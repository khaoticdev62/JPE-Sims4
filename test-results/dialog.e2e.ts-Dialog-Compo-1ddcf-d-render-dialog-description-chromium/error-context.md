...
- Name: dialog.e2e.ts >> Dialog Component >> should render dialog description
- Location: src\__tests__\e2e\specs\dialog.e2e.ts:35:7
...
Locator: getByTestId('dialog-description')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('dialog-description')
