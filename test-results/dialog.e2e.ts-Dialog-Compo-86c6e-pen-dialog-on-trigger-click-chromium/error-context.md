...
- Name: dialog.e2e.ts >> Dialog Component >> should open dialog on trigger click
- Location: src\__tests__\e2e\specs\dialog.e2e.ts:18:7
...
Locator: getByTestId('dialog-content')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('dialog-content')
