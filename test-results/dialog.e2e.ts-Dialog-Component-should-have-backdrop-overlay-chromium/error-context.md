...
- Name: dialog.e2e.ts >> Dialog Component >> should have backdrop overlay
- Location: src\__tests__\e2e\specs\dialog.e2e.ts:126:7
...
Locator: locator('[class*="DialogOverlay"]').first()
Expected: visible
Timeout: 5000ms
